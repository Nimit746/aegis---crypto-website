...
export function ExplainableAI() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {dynamicInsights.map((insight) => {
          ...
          return (
            <div
              key={insight.id}
              className="p-4 rounded-xl border bg-linear-to-b from-gray-900/30 to-transparent"
            >
              {/* Header */}
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className={`text-xs px-2 py-1 rounded ${insight.impact === "Bullish" ? "bg-green-500/20 text-green-400" :
              ...
              <div className="mt-4">
                ...
                <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden">
                  <div
                    className={`h-full rounded-full ${insight.color === "blue" ? "bg-blue-500" :
      ...
      {/* Recommendation */}
      <div className="p-4 bg-linear-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-lg">

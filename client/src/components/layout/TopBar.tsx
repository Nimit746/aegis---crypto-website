...
export function TopBar() {
    return (
        <header className="flex h-20 items-center justify-between border-b border-border bg-background px-8">
            {/* Search Bar */}
            <div className="flex w-96 items-center gap-3 rounded-xl bg-card border border-border px-4 py-2.5 shadow-sm focus-within:border-muted-foreground/30 transition-colors">
            ...
            <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 rounded-full bg-muted/20 px-3 py-1.5 border border-bullish/20">
